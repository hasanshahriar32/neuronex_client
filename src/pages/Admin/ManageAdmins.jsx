...
const ManageAdmins = () => {
        ...
        try {
            const user = async () => {
                ...
                const { data } = await axios.get(
                    `https://neuronex-server-test.vercel.app/admin/all`,
    ...
    useEffect(() => {
        try {
            const user = async () => {
                ...
                const { data } = await axios.get(
                    `https://neuronex-server-test.vercel.app/user/user?search=${search}`,
    ...
    const handleAdd = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(
                "https://neuronex-server-test.vercel.app/admin",
                data,
                config
            );
    ...
    //       },
    //     };
    //     const url = `https://neuronex-server-test.vercel.app/admin/${adminToRemove?._id}`;
    //     // console.log(url);
    ...
    const handleRemove = async (e) => {
        ...
        try {
            const response = await axios.delete(
                `https://neuronex-server-test.vercel.app/admin/${adminToRemove._id}`,
                { data, headers }
            );
                                        ...
                                        <tbody>
                                            {admin.map((adminData) => (
                                                ...
                                                >
                                                    ...
                                                    <td className="hidden md:block">{adminData?.email}</td>
                                                    <td className=" flex items-center justify-end">
                                                        <div className="tooltip  tooltip-left" data-tip={adminData?.email}>
                                                            <button
