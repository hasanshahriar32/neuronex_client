...
const ManageAdmins = () => {
        ...
        try {
            const user = async () => {
                ...
                const { data } = await axios.get(
                    `https://neuronex-server.vercel.app/admin/all`,
    ...
    useEffect(() => {
        try {
            const user = async () => {
                ...
                const { data } = await axios.get(
                    `https://neuronex-server.vercel.app/user/user?search=${search}`,
    ...
    const handleAdd = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(
                "https://neuronex-server.vercel.app/admin",
                data,
                config
            );
    ...
    //       },
    //     };
    //     const url = `https://neuronex-server.vercel.app/admin/${adminToRemove?._id}`;
    //     // console.log(url);
    ...
    const handleRemove = async (e) => {
        ...
        try {
            const response = await axios.delete(
                `https://neuronex-server.vercel.app/admin/${adminToRemove._id}`,
                { data, headers }
            );
