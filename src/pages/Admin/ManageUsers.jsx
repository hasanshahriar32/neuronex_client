        ...
        try {
            const user = async () => {
                ...
                const { data } = await axios.get(
                    `https://neuronex-server.vercel.app/user/all?page=${page}&limit=8`,
                    config
                );
                setUserData(data);
            };
        ...
        try {
            const user = async () => {
                ...
                const { data } = await axios.delete(
                    `https://neuronex-server.vercel.app/admin/user/${id}`,
                    config
                );
    ...
    const handleUid = async (uid) => {
        ...
        try {
            ...
            const { data: dataGet } = await axios.post(
                `https://neuronex-server.vercel.app/transaction/admin/all/${localStorage.getItem(
                    "user_id"
                )}`,
                { uid },
                config
