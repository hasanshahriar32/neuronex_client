...
const Price = () => {
    ...
    return (
        <div className="-mt-[250px] lg:px-[80px] ">
            <div className="mb-4">
                <h2 className="text-5xl text-center mb-10">Package to suit your plan</h2>
                    ...
                    <>
                        <div className="backdrop-blur-lg shadow-lg rounded-lg overflow-hidden border hover:scale-95 duration-150 cursor-pointer ">
                            <div className="p-4">
                                ...
                                <ul className="mt-4 ">
                                    <p className="text-gray-900 text-lg font-semibold">validity :{data?.validity}</p>
                                    <p className="text-gray-700 font-semibold text-lg">Generation:{data?.estimatedGeneration}(EST)</p>
                                </ul>
                                <label
                                    onClick={() => setPackage(data)}
                                    htmlFor="my-modal-3" className='btn btn-sm btn-warning mt-4'>PAY</label>
                            </div>
                        </div></>
                )}
            </div>
