                ...
                <div className="col-span-full lg:col-span-1 flex flex-col sm:flex-row justify-center items-start">
                    ...
                    <ul className="mb-4 sm:mb-0 px-4 flex sm:flex-col justify-center items-center space-x-3 sm:space-x-0 sm:space-y-3">
                        {people.map((person, index) => (
                            <li
                                key={person.lastname}
                                className={`w-12 h-12 rounded-full overflow-hidden filter ${index !== member
                ...
                <div className="col-span-full lg:col-span-1 mx-0 sm:mx-auto lg:mx-0 max-w-lg flex flex-col justify-center space-y-4">
                    ...
                    <div className="mb-4 inline-flex space-x-4">
                        ...
                        <a
                            ...
                            className={`text-gray-600 hover:text-red-600 ${!people[member].facebookURL && "hidden"
                                }`}
                        >
                            <svg
                                className="w-6 h-6"
                        ...
                        <a
                            ...
                            className={`text-gray-600 hover:text-red-600 ${!people[member].githubURL && "hidden"
                                }`}
                        >
                            <svg
                                className="w-6 h-6"
                        ...
                        <a
                            ...
                            className={`text-gray-600 hover:text-red-600 ${!people[member].linkedinURL && "hidden"
                                }`}
                        >
                            <svg
                                className="w-6 h-6"
                        ...
                        <a
                            ...
                            className={`text-gray-600 hover:text-red-600 ${!people[member].youtubeURL && "hidden"
                                }`}
                        >
                            <svg
                                className="w-6 h-6"
