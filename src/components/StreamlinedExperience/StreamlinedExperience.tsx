...
export const StreamlinedExperience = () => {
  ...
  return (
    ...
    >
      <motion.div
        style={{ position }}
        className="top-1/2 left-1/2 min-h-[50rem] min-w-[50rem] -translate-x-1/2 -translate-y-1/2 whitespace-nowrap before:absolute before:inset-0 before:scale-[var(--scale)] before:border-[2.5rem] before:border-warning before:opacity-[var(--opacity-border)]"
      >
        <motion.p
          aria-hidden
          style={{ x: textX, y: "-50%" }}
        ...
        <motion.p
          ...
          className="absolute left-1/2 top-1/2 text-[8.8rem] leading-tight text-grey-200"
        >
          Enhanced
          <br />
          Education.
