...
const Contact = () => {
    return (
        <div>
            <div className="container my-24 mx-auto md:px-6 text-md">
                <section className="mb-32">
                    <div className="relative h-[300px] overflow-hidden bg-cover bg-[50%] bg-no-repeat bg-[url('https://i.ibb.co/KD78n2D/Whats-App-Image-2023-07-06-at-12-12-27-AM.jpg')]"></div>
