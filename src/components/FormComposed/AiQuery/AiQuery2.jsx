                            ...
                            <div key={message.id}>
                                ...
                                >
                                    <div className="flex items-end">
                                        <div
                                            className={`flex flex-col space-y-2 text-xs w-full min-w-xs mx-2 order-${message.type === "incoming" ? 2 : 1
                                        ...
                                        >
                                            <div>
                                                <pre
                                                    ...
                                                    className={`px-4  py-2 rounded-lg inline-block rounded-${message.type === "incoming" ? "bl" : "br"
