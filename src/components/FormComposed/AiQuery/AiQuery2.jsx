            ...
            {messages.map((message) => (
              <div key={message.id}>
                ...
                >
                  ...
                  >
                    <div
                      className={`flex flex-col md:space-y-2 text-sm w-full min-w-xs mx-2 order-${
                    ...
                    >
                      <div>
                        <pre
                          ...
                          className={`px-1 py-2 rounded-lg inline-block text-lg rounded-${
