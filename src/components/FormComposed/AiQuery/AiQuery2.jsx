...
const AiQuery2 = () => {
    ...
    const { messages, sessionMessageLoading, setMessages } = useContext(ChatContext);
    ...
    const handleSendMessage = () => {
        ...
        if (message !== "") {
            ...
            const promptConfig = {
                subjectSelection, question: message, sessionId, additionalInstruction,
                assistanceLevel, uid: user?.uid,
            };
            fetch(
    ...
    const handleSearchSuggestion = async (message) => {
        ...
        try {
            ...
            const { data: dataGet } = await axios.post(
                ...
                {
                    sessionId: aiConfig?.sessionId, message: message, uid: user?.uid,
                },
                config
            );
        ...
        <div>
            ...
            <div className="flex-1 md:px-[5%] justify-between flex flex-col w-[95vw] lg:w-[70vw] py-2 min-h-screen max-h-screen">
                    ...
                    <div className="flex items-start flex-col ">
                        <div className="flex ml-2 items-center space-x-2">
                            ...
                            <label
                                // type="checkbox"
                                htmlFor="my_modal_4"
                                className=" tracking-wide btn btn-primary text-sm"
                            >
                                <span>
                                    <FiEdit3></FiEdit3>
                                </span>
                ...
                {sessionMessageLoading ? (
                    ...
                    <div
                        id="messages"
                        className="flex flex-col  chatScroll space-y-4  pt-3 md:p-3 overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-1 scrolling-touch min-h-[70vh]"
                    >
                ...
                <div className="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
                    <div className="relative flex">
                        ...
                        <div className="w-20 h-full max-h-20 items-stretch inset-y-0 flex">
                            <button
                                type="button"
                                className={`inline-flex h-[50px] backdrop-blur-sm border border-grey-dark focus:bg-transparent-white/20 bg-transparent-white items-center justify-center rounded-l-lg px-4 py-3 transition duration-500 ease-in-out text-white bg-blue-500 hover:bg-blue-400 focus:outline-none ${loadingAi ? "btn-disabled" : ""
                                    }`}
